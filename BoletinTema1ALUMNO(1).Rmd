...
tail(mammals)
str(mammals)
#dicho conjunto de datos contiene 62 registros y 2 variables

dim(Animals2)
head(Animals2)
tail(Animals2)
str(Animals2)
#dicho conjunto de datos contiene 65 registros y 2 variables

colnames(mammals)
#2 columnas(variables) body brain
rownames(mammals)
#62 filas
...
d_frameM <- mammals
d_frameA <- Animals2
commonAnimals <- intersect(d_frameM, d_frameA)
...
animales_diferentes_M <- setdiff(rownames(d_frameM), rownames(d_frameA))
animales_diferentes_M
#Animales que estan solo en el conjunto de datos mammals 


animales_diferentes_A <- setdiff(rownames(d_frameA), rownames(d_frameM))
animales_diferentes_A
#Animales que estan solo en el conjunto de datos Animals2
...
#hay ciertos animales que se considerarían repetidos en ambos conjuntos, no obstante al no estar escritos igual no son identificados como iguales
...
#podríamos decir que no siguen una distribución Gaussiana
...
tail(cabbages)
str(cabbages)
#dicho conjunto de datos contiene 60 registros y 4 variables

any(is.na(cabbages))
#no contiene ningún valor perdido
...
tail(Chile)
str(Chile)
#dicho conjunto de datos contiene 2700 registros y 8 variables

any(is.na(Chile))
#contiene ningún valor perdido
...
#la vitamina c está mayormente proporcionada, es decir las dos variedades de calabaza contienen parecida cantidad de vitamina c, no obstante se puede observar un mayor contenido de vitamina c en la variedad c39
...
#no existe relación lineal pues pues los puntos no están agrupados en forma de linea
